...
function initialisation () {
	...
	zoneQuestion.innerHTML = listePaysCapitalesOceanie[nombreAleatoire].pays
...
function calculScore () {
	...
	let bonneReponse = suppressionAccents(listePaysCapitalesOceanie[nombreAleatoire].capitale.toLowerCase())
...
function affichageMauvaiseReponse () {
	zoneReponsePrecedente.innerHTML = "Mauvaise réponse, la réponse était " + listePaysCapitalesOceanie[nombreAleatoire].capitale
}
