...
let nombreAleatoire = Math.floor(Math.random()*(listePaysCapitalesAmerique.length))

function melange () {
	nombreAleatoire = Math.floor(Math.random()*(listePaysCapitalesAmerique.length))
}
...
function initialisation () {
	...
	zoneQuestion.innerHTML = listePaysCapitalesAmerique[nombreAleatoire].pays
...
function calculScore () {
	...
	let bonneReponse = suppressionAccents(listePaysCapitalesAmerique[nombreAleatoire].capitale.toLowerCase())
...
function affichageMauvaiseReponse () {
	zoneReponsePrecedente.innerHTML = "Mauvaise réponse, la réponse était " + listePaysCapitalesAmerique[nombreAleatoire].capitale
}
