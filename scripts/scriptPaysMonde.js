...
function initialisation () {
	...
	zoneQuestion.innerHTML = listePaysCapitalesMonde[nombreAleatoire].capitale
...
function calculScore () {
	...
	let bonneReponse = suppressionAccents(listePaysCapitalesMonde[nombreAleatoire].pays.toLowerCase())
...
function affichageMauvaiseReponse () {
	zoneReponsePrecedente.innerHTML = "Mauvaise réponse, la réponse était " + listePaysCapitalesMonde[nombreAleatoire].pays
}
