...
function initialisation () {
	...
	zoneQuestion.innerHTML = listePaysCapitalesAsie[nombreAleatoire].capitale
...
function calculScore () {
	...
	let bonneReponse = suppressionAccents(listePaysCapitalesAsie[nombreAleatoire].pays.toLowerCase())
...
function affichageMauvaiseReponse () {
	zoneReponsePrecedente.innerHTML = "Mauvaise réponse, la réponse était " + listePaysCapitalesAsie[nombreAleatoire].pays
}
